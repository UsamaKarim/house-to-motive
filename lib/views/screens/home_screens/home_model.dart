...
class UserData {
  ...
  UserData({required this.image, required this.username, required this.miles});
}

class LatestVideos {
  final String image;
  final String videoUrl;
  LatestVideos({required this.image, required this.videoUrl});
}

class RandomVideos {
  final String image;
  final String videoUrl;
  RandomVideos({required this.image, required this.videoUrl});
}
