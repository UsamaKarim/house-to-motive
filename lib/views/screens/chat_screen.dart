                          ...
                          children: [
                                          ...
                                          itemBuilder: (context, index) {
                                            DateTime dateTime = DateTime.parse(
                                                getChatSController
                                                        .lastMessageTimeList[
                                                    index]);
                                            String dayOfMonth = DateFormat('HH')
                                                .format(dateTime);
                            ...
                            getChatSController.nameList.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    itemCount:
                                        getChatSController.nameList.length,
                                    itemBuilder: (context, index) {
                                      DateTime dateTime = DateTime.parse(
                                          getChatSController
                                          ...
                                          Get.to(
                                            () => ChatPage(
                                              name: getChatSController
                                                  .nameList[index],
                                              receiverEmail: getChatSController
                                                  .activeIdsList[index],
                                        ...
                                        onTap: () {
                                          Get.to(
                                            () => ChatPage(
                                              ...
                                              receiverId: getChatSController
                                                  .activeIdsList[index],
                                              chatRoomId: FirebaseAuth.instance
                                                          .currentUser !=
                                                      null
                                                  ? getChatSController
                                                      .chatRoomId(
